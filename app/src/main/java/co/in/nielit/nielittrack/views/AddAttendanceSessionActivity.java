...
public class AddAttendanceSessionActivity extends AppCompatActivity {
    ...
    private final String[] branchString = new String[]{"BCA", "BSC", "B.Tech", "M.Tech", "MCA","M.Sc"};
    private final String[] SemString = new String[]{"1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th"};
    private final String[] subjectFinal = new String[]{"DJANGO", "DATABASE", "AI", "PYTHON", "JAVA", "C++"};
